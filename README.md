...
This method work on servers run [ubuntu 20.04 LTS](https://releases.ubuntu.com/focal/) or [debian 10]([https://releases.ubuntu.com/focal/](https://cdimage.debian.org/debian-cd/project/build/10.13.0/)https://cdimage.debian.org/debian-cd/project/build/10.13.0/)
